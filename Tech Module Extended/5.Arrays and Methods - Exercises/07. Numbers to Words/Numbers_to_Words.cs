...
namespace _07.Numbers_to_Words
{
    public class Numbers_to_Words
    {
        ...
        static void PrintNumberInWords(string currentNumber)
        {
            string[,] numbers =
            { 
        ...
        static int ParseLenght(string currentNumber, int numberLenght, int v1, int v2)
        {
        ...
        static string Hundreds(string[,] numbers, int h, int t, int d, int numberLenght)
        {
        ...
        static string Tens(string[,] numbers, int t, int d)
        {
