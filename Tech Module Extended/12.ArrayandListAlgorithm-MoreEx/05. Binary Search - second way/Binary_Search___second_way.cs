...
namespace _05.Binary_Search___second_way
{
    public class Binary_Search___second_way
    {
        static bool isFound;
        ...
        static int DoBinarySearchAndCountIterations(List<int> list, int numberToFind, int binarySearchCounter)
        {
            int left = 0;
        ...
        static int DoLinearSearchAndCountIterations(List<int> list, int numberToFind, int linearSearchCounter)
        {
