...
namespace _10.Student_Groups_second_way
{
    public class Student_Groups_second_way
    {
        ...
        private static List<Group> GetGroups(List<Town> towns)
        {
            ...
            foreach (var town in towns.OrderBy(x => x.Name))
            {
                ...
                IEnumerable<Student> studs = town.Students.OrderBy(x => x.RegistrationDate).
                    ThenBy(z => z.Name).ThenBy(y => y.Email);
        ...
        private static List<Town> GetTownData()
        {
            ...
            while (inputLine != "End")
            {
                ...
                {
                    List<string> input = inputLine.Split(new char[] { '|' }, 
                        StringSplitOptions.
                    ...
                    DateTime regDate = DateTime.ParseExact(input[2], "d-MMM-yyyy", 
