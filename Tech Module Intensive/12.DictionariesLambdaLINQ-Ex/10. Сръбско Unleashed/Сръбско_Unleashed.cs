...
namespace _10.Сръбско_Unleashed
{
    public class Сръбско_Unleashed
    {
        ...
        {
            Dictionary<string, Dictionary<string, long>> cityProfit =
            ...
            while (!singerInfo[0].Equals("End"))
            {
                ...
                {
                    string[] leftPart = singerInfo[0].
                        Split(new char[] { ' ' }, 
                        StringSplitOptions.RemoveEmptyEntries).ToArray();

                    string[] rightPart = singerInfo[1].
                        Split(new char[] { ' ' }, 
                        StringSplitOptions.RemoveEmptyEntries).ToArray();
        ...
        private static void InsertProfit(Dictionary<string, Dictionary<string, long>>
            cityProfit, string newCity, string singer, long profit)
        {
